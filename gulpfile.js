...
gulp.task("lightgalleryCss", function(){
    return gulp.src(["node_modules/lightgallery/css/lightgallery-bundle.min.css"])
    .pipe(gulp.dest(sourceFolder + '/scss/lib'));
    });

gulp.task("lightgalleryJs", function(){
    return gulp.src(["node_modules/lightgallery/lightgallery.min.js"])
    .pipe(gulp.dest(sourceFolder + '/js/lib'));
    });

gulp.task("lightgallery", gulp.parallel("lightgalleryCss", "lightgalleryJs"));
